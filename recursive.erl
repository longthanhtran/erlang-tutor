-module(recursive).
-export([fac/1, len/1, tail_fac/1, duplicate/2, tail_duplicate/2, reverse/1, tail_reverse/1, sublist/2, tail_sublist/2, zip/2, lenient_zip/2, tail_zip/2, tail_lenient_zip/2, quicksort/1, partition/4, lc_quicksort/1, bestest_qsort/1, bestest_partition/4]).
...
tail_lenient_zip(_, [], Acc) -> Acc;
tail_lenient_zip([L1|L1s], [L2|L2s], Acc) ->
  tail_lenient_zip(L1s, L2s, [{L1,L2}|Acc]).
